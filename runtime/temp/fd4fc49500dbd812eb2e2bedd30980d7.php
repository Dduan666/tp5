<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:52:"D:\WWW\tp5\public/../app/admin\view\index\index.html";i:1493950257;s:60:"D:\WWW\tp5\public/../app/admin\view\Layout\index_layout.html";i:1493950255;s:52:"D:\WWW\tp5\public/../app/admin\view\Public\meta.html";i:1493950255;s:53:"D:\WWW\tp5\public/../app/admin\view\Public\style.html";i:1493950255;s:56:"D:\WWW\tp5\public/../app/admin\view\Public\left_nav.html";i:1493950255;s:57:"D:\WWW\tp5\public/../app/admin\view\Public\right_con.html";i:1493950255;s:57:"D:\WWW\tp5\public/../app/admin\view\Public\right_sid.html";i:1493950255;s:52:"D:\WWW\tp5\public/../app/admin\view\Public\chat.html";i:1493950255;s:54:"D:\WWW\tp5\public/../app/admin\view\Public\script.html";i:1493950255;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a class="J_menuItem" href="<?php echo url('admin/user'); ?>" data-index="0">
                            <i class="fa fa-users"></i>
                            <span class="nav-lable">管理员管理</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="<?php echo url('admin/role'); ?>" data-index="0">
                            <i class="fa fa-check-square"></i>
                            <span class="nav-lable">角色管理</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="index_v1.html" data-index="0">
                            <i class="fa fa-check-square-o"></i>
                            <span class="nav-lable">权限管理</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li>
                <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">博客</span></a>
            </li>
            <li>
                <a href="#">
            ...
            <li>
                <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">商城</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">公司</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="#"><i class="fa fa-table"></i> <span class="nav-label">微信</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="#"><i class="fa fa-flask"></i> <span class="nav-label">公共信息</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
...
<div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="row content-tabs">
        ...
        <a href="<?php echo url('User/login'); ?>" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
    </div>
    <div class="row J_mainContent" id="content-main">
        <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo url('Test/test'); ?>" frameborder="0" data-id="index_v1.html" seamless></iframe>
    </div>
    <div class="footer">
